...
public class FilterTest {
    ...
    public void shouldCreateSetsFromLists() {
        ...
        List<Integer> ids = new ArrayList<>(Arrays.asList(1,2,5));
        ...
        assertTrue(filter.getProvidersSet().get().contains(1));
        assertTrue(filter.getProvidersSet().get().contains(2));
        assertTrue(filter.getProvidersSet().get().contains(5));
    ...
    public void shouldCreateListsFromSets() {
        ...
        Set<Integer> ids = new HashSet<>(Arrays.asList(1,2,5));
        ...
        assertTrue(filter.providers().get().contains(1));
        assertTrue(filter.providers().get().contains(2));
        assertTrue(filter.providers().get().contains(5));
